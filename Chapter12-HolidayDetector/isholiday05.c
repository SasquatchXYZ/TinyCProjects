...
int is_holiday(struct holiday* holiday)
{
    ...
    // Martin Luther King Jr. Day
    if (holiday->month == 0 && holiday->weekday == MONDAY)
    {
        if (THIRD_WEEK)
        {
    ...
    // Presidents Day
    if (holiday->month == 1 && holiday->weekday == MONDAY)
    {
        if (THIRD_WEEK)
        {
    ...
    // Memorial Day
    if (holiday->month == 4 && holiday->weekday == MONDAY)
    {
        if (LAST_WEEK)
        {
    ...
    // Labor Day
    if (holiday->month == 8 && holiday->weekday == MONDAY)
    {
        if (FIRST_WEEK)
        {
    ...
    // Columbus Day
    if (holiday->month == 9 && holiday->weekday == MONDAY)
    {
        if (SECOND_WEEK)
        {
